...
function controlla_login(user,psw){
  ...
  var query = "http://dashboard.gestionaleclj.com/script_php/login.php?"+stringaR ;
  $.ajax({
      url: query,
      async:false,
      success: function(data) {
		  ...
		  if((data != null)&&(data[0]!=null)){
            ...
            Materialize.toast('Login avvenuto con successo!', 2000,'',function(){window.location.href = 'dashboard.html?nomeDB=' +nomedb+'&classe_privilegi='+admin+'&id_dipendente='+id_dip+'&username='+username});
          }else{
