...
function populateList(filter){
	...
	$.ajax({
      dataType: "json",
      url: "http://dashboard.gestionaleclj.com/script_php/getClients.php?q="+ q+"&db="+getUrlVars()['nomeDB'], //Relative or absolute path to response.php file
      data:"",
...
function explodeClient(cliente){
	...
	if(cliente['tipologia'] == 'p'){
		$("#logo_cliente").append('<i id="logo_cliente" class="large material-icons blue-text">&#xE853;</i>');
		$("#nominativo").append('<div class="blue-text" style="margin-left:15%;">Nominativo </div><i class="info small material-icons blue-text">&#xE853;</i> '+cliente['nominativo']);
			}
	else
	{
		$("#logo_cliente").append('<i id="logo_cliente" class="large material-icons blue-text">&#xE0AF;</i>');
		$("#nominativo").append('<div class="blue-text" style="margin-left:15%;">Ragione Sociale </div><i class="info small material-icons blue-text">&#xE0AF;</i>'+cliente['nominativo']);
	}
    ...
    if(cliente['indirizzo'] != null && cliente['citta'] != null && cliente['cap'] != null && cliente['provincia'] != null && cliente['indirizzo'] != "" && cliente['citta'] != "" && cliente['cap'] != "" && cliente['provincia'] != "")
       $("#indirizzi").append('<div class="blue-text" style="margin-left:15%;">Indirizzo </div><i class="info small material-icons blue-text">&#xE55F;</i>'+cliente['indirizzo']+' - '+cliente['citta']+' - '+cliente['cap']+ ' - '+cliente['provincia']);
	if(cliente['telefono'] != null && cliente['telefono'] != "")
       $("#telefono").append('<div class="blue-text" style="margin-left:15%;">Telefono </div><i class="info small material-icons blue-text">&#xE0CD;</i>'+cliente['telefono']);
	if(cliente['cellulare'] != null && cliente['cellulare'] != "")
       $("#cellulare").append('<div class="blue-text" style="margin-left:15%;">Cellulare </div><i class="info small material-icons blue-text">&#xE325;</i>'+cliente['cellulare']);
    if(cliente['codice_fiscale'] != null && cliente['codice_fiscale'] != "") {
		$("#codice_fiscale").append('<div class="blue-text" style="margin-left:15%;">Codice Fiscale </div><i class="info small material-icons blue-text">&#xE86F;</i>'+cliente['codice_fiscale']);
		}
	if(cliente['partita_iva'] != null && cliente['partita_iva'] != "")
		$("#partita_iva").append('<div class="blue-text" style="margin-left:15%;">Partita Iva </div><i class="info small material-icons blue-text">&#xE86F;</i>'+cliente['partita_iva']);
    if(cliente['email'] != null && cliente['email'] != "")
       $("#email").append('<div class="blue-text" style="margin-left:15%;">Email </div> <i class="info small material-icons blue-text">&#xE0BE;</i>'+cliente['email']);
    if(cliente['sito'] != null && cliente['sito'] != "")
       $("#site").append('<div class="blue-text" style="margin-left:15%;">Sito Web </div><i class="info small material-icons blue-text">&#xE80B;</i>'+cliente['sito']);
      if(cliente['note'] != null && cliente['note'] != "")
       $("#note").append('<div class="blue-text" style="margin-left:15%;">Note </div><i class="info small material-icons blue-text">&#xE0CA;</i>'+cliente['note']);
...
function deleteCliente(){
	...
	$.ajax({
		url: "http://dashboard.gestionaleclj.com/script_php/deleteClient.php", //Relative or absolute path to response.php file
	      type:"POST",	
...
function modifyCliente(){
	...
	$.ajax({
	     url: "http://dashboard.gestionaleclj.com/script_php/updateClients.php", //Relative or absolute path to response.php file
	      type:"POST",
	      async:false,
	      data:{
