...
function populateListClient(filter){
	$.ajax({
      dataType: "json",
      url: "http://dashboard.gestionaleclj.com/script_php/getClients.php?q="+filter+"&db="+getUrlVars()['nomeDB'], //Relative or absolute path to response.php file
      data:"",
		...
		$.ajax({
	      ...
	      data:{
		   ...
		   success: function(data){		   
		   		...
		   		$.ajax({
			      dataType: "json",
			      url: "http://dashboard.gestionaleclj.com/script_php/getClients.php?q="+nominativo+"&db="+getUrlVars()['nomeDB'], //Relative or absolute path to response.php file
			      data:"",
			      success: function(data) {
